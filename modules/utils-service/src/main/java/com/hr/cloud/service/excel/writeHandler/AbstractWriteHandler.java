package com.hr.cloud.service.excel.writeHandler;

import com.hr.cloud.service.excel.model.ExcelMetaData;
import org.apache.commons.lang3.StringUtils;
import org.apache.poi.hssf.usermodel.HSSFCellStyle;
import org.apache.poi.hssf.usermodel.HSSFDataFormat;
import org.apache.poi.ss.usermodel.*;
import org.springframework.util.CollectionUtils;
import com.hr.cloud.service.excel.annotation.ExcelCellUtils;
...
public abstract class AbstractWriteHandler<T> implements ExcelWriteHandler<T> {
  ...
  private Map<Field, CellStyle> styleMap = new ConcurrentHashMap<>();
  ...
  private CellStyle generateCellStyle(ExcelMetaData metaData) {
